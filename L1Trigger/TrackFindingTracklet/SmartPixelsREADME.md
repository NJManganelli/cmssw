## NEW 15_1_0_pre1 instructions with jet tagging
...
```
In src directory:
cp $PATH/TO/correctionlib_regression_smearing.json .
scram-venv cmsenv
cmsenv
...
git fetch njmanganelli-fork CMS-L1T-Jet-Tagging_for-DPS_cmssw_15_1_0_pre1_smartpixelstrackproducer
git checkout CMS-L1T-Jet-Tagging_for-DPS_cmssw_15_1_0_pre1_smartpixelstrackproducer
...
cmsRun L1Trigger/TrackFindingTracklet/python/runInputs151X_withAllSmartPixelsCollections.py
# this script produces alternative nano + perf ntuples, not sure on contents or such, but also use the slimmed inputs that the runInputs scripts produce
# cmsRun FastPUPPI/NtupleProducer/python/runPerformanceNTuple.py --140X_v0 TTbar_PU200 TTbar_PU200.140X_v
```
