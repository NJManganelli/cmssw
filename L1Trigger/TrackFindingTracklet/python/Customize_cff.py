...
def addSmartPixelsTrackProducerVariants(process):
  ...
  for rconf in regression_configs:
    ...
    getattr(process, fourparam).smartPixelsCorrectionSet = cms.FileInPath("L1Trigger/TrackFindingTracklet/data/spixel_smear_all_configs_barrel_CalV1_v2p1_compound.json")
    ...
    getattr(process, fiveparam).smartPixelsCorrectionSet = cms.FileInPath("L1Trigger/TrackFindingTracklet/data/spixel_smear_all_configs_barrel_CalV1_v2p1_compound.json")
