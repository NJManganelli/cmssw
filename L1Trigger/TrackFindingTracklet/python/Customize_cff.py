...
def addSmartPixelsTrackProducerVariants(process):
  ...
  for rconf in regression_configs:
    ...
    getattr(process, fourparam).smartPixelsCorrectionSet = "spixel_smear_all_configs_barrel_CalV1_v2p1_compound.json"
    ...
    getattr(process, fiveparam).smartPixelsCorrectionSet = "spixel_smear_all_configs_barrel_CalV1_v2p1_compound.json"
