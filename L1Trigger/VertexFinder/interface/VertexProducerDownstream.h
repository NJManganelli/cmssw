#ifndef __L1Trigger_VertexFinder_VertexProducerDownstream_h__
#define __L1Trigger_VertexFinder_VertexProducerDownstream_h__
...
class VertexProducerDownstream : public edm::global::EDProducer<> {
public:
  explicit VertexProducerDownstream(const edm::ParameterSet&);
  ~VertexProducerDownstream() override {}
