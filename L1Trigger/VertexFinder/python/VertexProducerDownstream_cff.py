...
VertexProducerDownstream = cms.EDProducer('VertexProducerDownstream',

  l1TracksInputTag = cms.InputTag("L1TrackSelectionProducer", "Level1TTTracksSelectedEmulation"),
