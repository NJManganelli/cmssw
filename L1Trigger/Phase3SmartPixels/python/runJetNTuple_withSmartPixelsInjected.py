...
from L1Trigger.Phase3SmartPixels.customizeSmartPixels_cff import smartPixelsVariantLabels, PASSTHROUGH_MODES
if options.emulatorMode.lower() == "correctionlibtptoysmear":
...
assert options.emulatorMode in PASSTHROUGH_MODES + ["correctionlibRegression"]
spixfourparam, spixfiveparam = smartPixelsVariantLabels(options.emulatorMode, options.activeSP or None)
...
from L1Trigger.Phase3SmartPixels.customizeSmartPixels_cff import injectSmartPixelsTrackProducer
