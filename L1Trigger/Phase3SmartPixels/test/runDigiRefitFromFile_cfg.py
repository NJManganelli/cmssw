...
options.setDefault('inputFiles',
                   'file:/work/testfiles/RelValTTbar_14TeV_PU_150X_mcRun4_realistic_v1_STD_D121_RegeneratedGS_PU-v1.root')
...
# remade). Post-PR#51503 layout: lives in TrackFindingTracklet and pulls the
# tt::Setup + data-format ESProducers itself.
process.load('L1Trigger.TrackTrigger.TrackTrigger_cff')  # TTStub algorithm records
process.load('L1Trigger.TrackerDTC.Setup_cff')
