...
l1tTrackJets.VertexInputTag  = ("l1tVertexFinderEmulator","l1verticesEmulation")
l1tTrackFastJets.L1PrimaryVertexTag  = ("l1tVertexFinder", "l1vertices")
l1tTrackJetsExtended.VertexInputTag  = ("l1tVertexFinderEmulator","l1verticesEmulation")
