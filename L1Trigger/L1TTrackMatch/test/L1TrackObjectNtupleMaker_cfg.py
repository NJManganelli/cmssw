...
process.L1TrackNtuple = cms.EDAnalyzer('L1TrackObjectNtupleMaker',
        ...
        TrackMETExtendedInputTag = cms.InputTag("l1tTrackerEtMissExtended","l1tTrackerExtendedEtMiss"),
        TrackMETEmuInputTag = cms.InputTag("l1tTrackerEmuEtMiss","l1tTrackerEmuEtMiss")
        ...
        RecoVertexInputTag=cms.InputTag("l1tVertexFinder", "l1tVertices"),
        RecoVertexEmuInputTag=cms.InputTag("l1tVertexFinderEmulator", "l1tVerticesEmulation"),
)
