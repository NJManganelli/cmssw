...
L1TrackVertexAssociationProducer = cms.EDProducer('L1TrackVertexAssociationProducer',
  l1SelectedTracksInputTag = cms.InputTag("L1TrackSelectionProducer", "Level1TTTracksSelected"),
  l1SelectedTracksEmulationInputTag = cms.InputTag("L1TrackSelectionProducer", "Level1TTTracksSelectedEmulation"),
...
L1TrackVertexAssociationProducerExtended = L1TrackVertexAssociationProducer.clone(
  l1SelectedTracksInputTag = cms.InputTag("L1TrackSelectionProducer", "Level1TTTracksSelected"),
  l1SelectedTracksEmulationInputTag = cms.InputTag("L1TrackSelectionProducer", "Level1TTTracksSelectedEmulation"),
