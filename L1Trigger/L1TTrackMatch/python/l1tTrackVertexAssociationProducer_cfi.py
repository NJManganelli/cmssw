...
l1tTrackVertexAssociationProducerForJets = cms.EDProducer('L1TrackVertexAssociationProducer',
...
l1tTrackVertexAssociationProducerExtendedForJets = l1tTrackVertexAssociationProducer.clone(
  l1SelectedTracksInputTag = cms.InputTag("l1tTrackSelectionProducerExtendedForJets", "Level1TTTracksSelected"),
  l1SelectedTracksEmulationInputTag = cms.InputTag("l1tTrackSelectionProducerExtendedForJets", "Level1TTTracksSelectedEmulation"),
  outputCollectionName = cms.string("Level1TTTracksExtendedSelectedAssociated"),
  cutSet = cms.PSet(
                    #deltaZMaxEtaBounds = cms.vdouble(0.0, absEtaMax.value), # these values define the bin boundaries in |eta|
                    #deltaZMax = cms.vdouble(0.5), # delta z must be less than these values, there will be one less value here than in deltaZMaxEtaBounds, [cm]
...
l1tTrackVertexAssociationProducerForEtMiss = cms.EDProducer('L1TrackVertexAssociationProducer',
...
l1tTrackVertexAssociationProducerExtendedForEtMiss = l1tTrackVertexAssociationProducer.clone(
  l1SelectedTracksInputTag = cms.InputTag("l1tTrackSelectionProducerExtendedForEtMiss", "Level1TTTracksSelected"),
  l1SelectedTracksEmulationInputTag = cms.InputTag("l1tTrackSelectionProducerExtendedForEtMiss", "Level1TTTracksSelectedEmulation"),
  outputCollectionName = cms.string("Level1TTTracksExtendedSelectedAssociated"),
  cutSet = cms.PSet(
                    #deltaZMaxEtaBounds = cms.vdouble(0.0, absEtaMax.value), # these values define the bin boundaries in |eta|
                    #deltaZMax = cms.vdouble(0.5), # delta z must be less than these values, there will be one less value here than in deltaZMaxEtaBounds, [cm]
