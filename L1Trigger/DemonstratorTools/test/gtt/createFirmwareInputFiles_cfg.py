...
# from L1Trigger.VertexFinder.l1tVertexProducer_cfi import l1tVertexProducer #FIXME
...
process.l1tGTTInputProducer.l1TracksInputTag = cms.InputTag("l1tTTTracksFromTrackletEmulation", "Level1TTTracks")
