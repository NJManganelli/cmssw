...
process.l1tVertexProducerEmu = l1tVertexProducer.clone()
process.l1tVertexProducerEmu.l1TracksInputTag = cms.InputTag("l1tTrackSelectionProducer", "Level1TTTracksSelectedEmulation")
process.l1tVertexProducerEmu.l1VertexCollectionName = cms.string("l1vertices")
process.l1tVertexProducerEmu.VertexReconstruction.Algorithm = cms.string("fastHistoEmulation")
process.l1tVertexProducerEmu.VertexReconstruction.VxMinTrackPt = cms.double(0.0)
process.l1tVertexProducerEmu.debug = options.debug
...
process.l1tTrackVertexAssociationProducer.l1VerticesInputTag = cms.InputTag("l1tVertexProducerSim", "l1vertices")
process.l1tTrackVertexAssociationProducer.l1VerticesEmulationInputTag = cms.InputTag("l1tVertexProducerEmu", "l1verticesEmulation")
