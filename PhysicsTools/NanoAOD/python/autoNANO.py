...
autoNANO = {
    ...
    #  Require l1tSmartPixelsTrackProducer{,Extended} from the smartpixels development branch.
    'L1PFTrkNanoSmartPix' : {'sequence': '@Phase2L1DPG',
                             'customize': '+'.join(['@L1PFTrkNano',
                                                    'DPGAnalysis/Phase2L1TNanoAOD/l1tPh3SmartPixelsNano_cff.addPh3L1SmartPixelsTracks']),},
