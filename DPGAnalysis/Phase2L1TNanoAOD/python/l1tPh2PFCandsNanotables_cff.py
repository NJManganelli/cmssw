...
#### NOTE (20->17 backport): the module LABEL must end in "Table" or the
#### NANOAOD output (keep nanoaodFlatTable_*Table_*_*) silently drops the
#### FlatTable and hgcClusterIdx never appears. The table NAME/column NAME
#### (L1PuppiCand / hgcClusterIdx) are unchanged, so ngtagger schema is intact.
